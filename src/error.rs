    ...
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        match self {
            ...
            Reason::Xml(e) => match e {
                ...
                XmlError::Utf8(err) => write!(f, "UTF-8 error: {}", err),
...
impl From<XmlError> for Error {
    fn from(e: XmlError) -> Self {
        let offset: usize = match &e {
            XmlError::NameWithQuote(pos) => *pos,
            XmlError::NoEqAfterName(pos) => *pos,
            XmlError::UnquotedValue(pos) => *pos,
            XmlError::DuplicatedAttribute(_pos1, pos2) => *pos2,
            _ => 0,
        };
